...
use `Project Points <https://natlabrockies.github.io/reV/_autosummary/reV.config.project_points.ProjectPoints.html#reV.config.project_points.ProjectPoints>`_ to define which resource sites (`gids`) to run through
...
`reV-project-points <https://natlabrockies.github.io/reV/_cli/reV-project-points.html#rev-project-points>`_
CLI
